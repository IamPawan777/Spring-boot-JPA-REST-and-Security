...
//	@PostConstruct
//	public void init() {
//		String encodedKey = "aBjkBjkJnJNjklLKLKNJknklKLAddioioj";
//		SECRET_KEY = Keys.hmacShaKeyFor(Base64.getDecoder().decode(encodedKey));
//	}
	...
	private final long TOKEN_EXPIRY_DURATION = 1000*60*2;
