...
//    JwtAuthFilter(UserRepository userRepository) {
...
//    }
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			sendErrorResponce(response, HttpServletResponse.SC_BAD_REQUEST, "Illegal Argument...!");
			return;
		}
		catch(Exception e) {
			sendErrorResponce(response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Unexpected Error occured...!");
			return;
		}
