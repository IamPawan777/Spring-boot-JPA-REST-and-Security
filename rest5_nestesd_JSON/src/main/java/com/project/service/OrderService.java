...
//			response.setMobile(details.getMobile());
			...
			List<ProductInfoResponse> allProducts = details.getProductinfo()
			 ...
			 if (details.getDelivaryAddress() != null) {
			        ...
			        addressResponse.setDPinCode(details.getDelivaryAddress().getDPinCode());
			        response.setDelivaryAddress(addressResponse);
			    }
			
			 if(details.getPaymentDetails() != null) {						 
					PaymentDetailsResponse paymentResponse = new PaymentDetailsResponse();
//					paymentResponse.setPPaidAmount(details.getPaymentDetails().getPPaidAmount());
					paymentResponse.setPStatus(details.getPaymentDetails().getPStatus());
//					paymentResponse.setPBankTransaction(details.getPaymentDetails().getPBankTransaction());
